...
class Cookbook {
    ...
    init() {
        ...
        let chickenTikkaMasala = Recipe(name: "Chicken Tikka Masala (butter chicken)",
        ...
        let sundubuJjigae = Recipe(name: "Sundubu Jjigae (Spicy Soft Tofu Stew)",
                                ...
                                spices: ["red chili flakes",
                                   ...
                                   vegetables: [Vegetables.bokChoy.rawValue,
                                             ...
                                             "spring onion",
                                             "white onion"])
        addRecipe(recipe: Recipe(name: "Elota",
                                 ingredients: ["Corn", "Red Chilli flakes"],
                                 recipeSteps: []))
        ...
        addRecipe(recipe: chickenTikkaMasala)
        addRecipe(recipe: sundubuJjigae)
