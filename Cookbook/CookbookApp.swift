...
struct CookbookApp: App {
    ...
    @StateObject var cookbook = Cookbook(recipes: [
                ...
                Recipe(name: "Elota",
                       ingredients: ["Corn", "Maynoise", "Lemon", "Butter"],
                       recipeSteps: [
                            recipeStep(title: "Butter corn", imageTitle: "elota-1"),
                            recipeStep(title: "Season corn", imageTitle: "elota-2"),
                            recipeStep(title: "Chop parsley", imageTitle: "elota-3"),
                            recipeStep(title: "", imageTitle: "elota-4"),
                            recipeStep(title: "", imageTitle: "elota-5"),
                            recipeStep(title: "", imageTitle: "elota-6"),
                            recipeStep(title: "", imageTitle: "elota-7"),
                            recipeStep(title: "", imageTitle: "elota-8"),
                            recipeStep(title: "", imageTitle: "elota-9"),
                            recipeStep(title: "", imageTitle: "elota-10"),
                            recipeStep(title: "", imageTitle: "elota-11"),
                            recipeStep(title: "", imageTitle: "elota-12"),
                            recipeStep(title: "Grill corn", imageTitle: "elota-13"),
                            recipeStep(title: "Coat corn", imageTitle: "elota-14"),
                            recipeStep(title: "", imageTitle: "elota-15"),
                            recipeStep(title: "", imageTitle: "elota-16"),
                            recipeStep(title: "Garnish with parsley and enjoy", imageTitle: "elota-17"),
                       ],
                       spices: [""],
